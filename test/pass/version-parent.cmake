...
write_version_cmake(${TMP_DIR}/repo "1.0 PARENT ${PARENT}" "
    ...
    test_expect_eq(\${CPACK_DEBIAN_PACKAGE_RELEASE} ${GIT_TAG})
    test_expect_eq(\${CPACK_RPM_PACKAGE_RELEASE} ${GIT_TAG})
    test_expect_eq(\${PROJECT_VERSION} \${PROJECT_VERSION_MAJOR}.\${PROJECT_VERSION_MINOR}.\${PROJECT_VERSION_PATCH})
")
